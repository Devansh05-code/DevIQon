...
// import { Sparkles, Edit } from 'lucide-react'; // ✅ Import Edit icon
...
//         <input
//           onChange={(e) => setInput(e.target.value)} // ✅ Corrected from onClick to onChange
//           value={input}
//           type='text'
...
//           <div className='text-sm flex felx-col items-center gap-5 text-gray-400'>
